            ...
            <div className="container">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            ...
                            <Avatar className="-ml-6 border-transparent group-hover:border-green-500 transition">
                                <div className="size-full inline-flex bg-neutral-700 rounded-full items-center justify-center gap-1 relative">
                                    <Image
                                        src={avatar4}
                                        alt=""
                                        className="absolute rounded-full opacity-0 group-hover:opacity-100 transition"
                                    />
                ...
                <div className="mt-8 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        <div
                            key={feature}
                            className="bg-neutral-900 border border-white/10 inline-flex px-3 py-1.5 rounded-2xl items-center gap-3 md:px-5 md:py-2 hover:scale-105 transition duration-500 group"
                        >
